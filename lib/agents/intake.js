...
function buildUserPrompt(briefText) {
  return [
    ...
    "",
    "2. An audience is a description of PEOPLE. A market, a place, a category, a",
    "   channel, or the product itself is not an audience. A brand *entering the",
    "   Tokyo night market* states a market, not an audience — that brief has no",
    "   audience and you must ask for one.",
    "",
    ...
    "",
    "6. Ask only about what would block planning. Not budget, timeline or approvals.",
  ].join("\n");
}
